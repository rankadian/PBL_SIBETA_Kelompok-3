...
-- Relasi Foreign Key antara TB_Upload dan TB_Surat
ALTER TABLE dbo.TB_Upload
ADD CONSTRAINT FK_Upload_Surat FOREIGN KEY (IDSurat) REFERENCES dbo.TB_Surat(IDSurat);
