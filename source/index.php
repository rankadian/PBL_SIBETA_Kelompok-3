...
switch (strtolower($page)) {
    ...
    case 'mahasiswa':
        ...
        break;
    case 'verifikasi':
        include('pages/verifikasiMahasiswa.php');
        break;
    default:
...
<script src="adminlte/plugins/datatables-buttons/js/buttons.print.min.js"></script> <script src="adminlte/plugins/datatables-buttons/js/buttons.colVis.min.js"></script> 
