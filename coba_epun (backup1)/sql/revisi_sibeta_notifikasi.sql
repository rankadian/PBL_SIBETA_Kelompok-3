...
-- Corrected Notifikasi from admin (misalnya ada ketidaksesuaian file)
INSERT INTO dbo.TB_NOTIFIKASI (mahasiswa_nim, pesan, tanggal_notifikasi) 
VALUES 
('19061003', 'Tanggungan absensi Anda belum lengkap. Silakan periksa kembali dokumen yang diunggah.', GETDATE()),
('19061004', 'Tanggungan UKT Anda mengalami ketidaksesuaian data. Silakan hubungi admin.', GETDATE()),
('19061001', 'Tanggungan PKL Anda berhasil diunggah dan tidak ada masalah.', GETDATE());

-- Corrected Notifikasi from KPS after admin verification
INSERT INTO dbo.TB_NOTIFIKASI (mahasiswa_nim, pesan, tanggal_notifikasi) 
VALUES 
('19061003', 'Tanggungan absensi Anda berhasil diverifikasi oleh admin dan diteruskan ke KPS.', GETDATE()),
('19061004', 'Tanggungan UKT Anda telah berhasil diverifikasi dan disetujui oleh KPS.', GETDATE());

-- Corrected Notifikasi after KPS verification
INSERT INTO dbo.TB_NOTIFIKASI (mahasiswa_nim, pesan, tanggal_notifikasi) 
VALUES 
('19061003', 'Tanggungan absensi Anda berhasil diverifikasi oleh KPS.', GETDATE()),
('19061004', 'Tanggungan UKT Anda berhasil diverifikasi dan diterima oleh KPS.', GETDATE());